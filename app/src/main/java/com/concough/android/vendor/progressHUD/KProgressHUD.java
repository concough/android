...
import com.concough.android.vendor.progressHUD.BarView;
...
public class KProgressHUD {
     ...
     */
    public static com.concough.android.vendor.progressHUD.KProgressHUD create(Context context) {
        return new com.concough.android.vendor.progressHUD.KProgressHUD(context);
    }
   ...
   * @return An unique HUD instance
   */
    public static com.concough.android.vendor.progressHUD.KProgressHUD create(Context context, Style style) {
        return new com.concough.android.vendor.progressHUD.KProgressHUD(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setSize(int width, int height) {
     ...
     */
    @Deprecated
    public com.concough.android.vendor.progressHUD.KProgressHUD setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setLabel(String label) {
        mProgressDialog.setLabel(label);
        return this;
    }

    /**
     * Optional label font to be displayed.
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setLabelFont(Typeface typeface) {
        mProgressDialog.setLabelFont(typeface);
        return this;
    }
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setAutoDismiss(boolean isAutoDismiss) {
     ...
     * @return Current HUD
     */
    public com.concough.android.vendor.progressHUD.KProgressHUD setGraceTime(int graceTimeMs) {
        mGraceTimeMs = graceTimeMs;
        return this;
    }

    public com.concough.android.vendor.progressHUD.KProgressHUD show() {
        if (!isShowing()) {
            mFinished = false;
            if (mGraceTimeMs == 0) {
    ...
    private class ProgressDialog extends Dialog {
        ...
        public void setLabelFont(Typeface typeface) {
            ...
            if (mLabelText != null) {
                if (typeface != null) {
                    mLabelText.setTypeface(typeface);
                }
            }
        }
