...
//                          Log.d(TAG, resCode.toString())
        ...
        @JvmStatic
        fun getEntranceMultiSaleData(context: Context, uniqueId: String, completion: (data: JsonElement?, error: HTTPErrorType?) -> Unit, failure: (error: NetworkErrorType?) -> Unit): Unit {
            var fullPath = UrlMakerSingleton.getInstance().getProductDataForEntranceMultiUrl(uniqueId) ?: return
